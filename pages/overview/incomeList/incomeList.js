// pages/overview/incomeList/incomeList.js
const app = getApp();
  ...
  getIncomeList: function() {
    ...
    switch (that.data.type) {
      ...
      case '1':
        ...
        break;
      case '2':
        url = api.dateScopeUrl;
        console.log(dateFormat.getFirstDayOfMonth(today))
        params = {
          agencyId: that.data.agencyId,
          routeId:'',
