// pages/operationManage/operationManage.js
...
Page({
  ...
  gotoEdit:function(e){
    ...
    if (this.data.lineList && this.data.lineList[index]){
      wx.setStorageSync("route", this.data.lineList[index]);
    }
    wx.navigateTo({
      url: 'workEfforts/workEfforts',
    })
  }
})